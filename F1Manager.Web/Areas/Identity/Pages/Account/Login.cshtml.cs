...
namespace F1Manager.Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        // Modelo de dados de entrada para o formulário de login
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            // Se o URL de retorno for a página de logout, redireciona para a raiz
            if (returnUrl.Contains("/Account/Logout") || returnUrl.Contains("/Logout"))
            {
                returnUrl = Url.Content("~/");
            }
